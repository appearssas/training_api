...
export class InitialSchema1766001884110 implements MigrationInterface {
    name = 'InitialSchema1766001884110'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`alumnos\` (\`id\` int NOT NULL AUTO_INCREMENT, \`codigo_estudiante\` varchar(50) NULL, \`fecha_ingreso\` date NULL, \`activo\` tinyint NOT NULL DEFAULT '1', \`fecha_creacion\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`persona_id\` int NULL, INDEX \`IDX_1c4bf20b7f94e724088a4c9867\` (\`codigo_estudiante\`), UNIQUE INDEX \`IDX_1c4bf20b7f94e724088a4c9867\` (\`codigo_estudiante\`), UNIQUE INDEX \`REL_81923965e846ea6bc6b1ae7a42\` (\`persona_id\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`instructores\` (\`id\` int NOT NULL AUTO_INCREMENT, \`especialidad\` varchar(200) NULL, \`biografia\` text NULL, \`calificacion_promedio\` decimal(3,2) NULL, \`total_capacitaciones\` int NOT NULL DEFAULT '0', \`total_estudiantes\` int NOT NULL DEFAULT '0', \`activo\` tinyint NOT NULL DEFAULT '1', \`fecha_creacion\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`fecha_actualizacion\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`persona_id\` int NULL, UNIQUE INDEX \`REL_37d658e0238dd3373fa1c35dbf\` (\`persona_id\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`tipos_capacitacion\` (\`id\` int NOT NULL AUTO_INCREMENT, \`nombre\` varchar(100) NOT NULL, \`codigo\` varchar(20) NOT NULL, \`descripcion\` text NULL, \`activo\` tinyint NOT NULL DEFAULT '1', \`fecha_creacion\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`fecha_actualizacion\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), UNIQUE INDEX \`IDX_14199ab69b3551092772c55223\` (\`codigo\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`modalidades_capacitacion\` (\`id\` int NOT NULL AUTO_INCREMENT, \`nombre\` varchar(50) NOT NULL, \`codigo\` varchar(20) NOT NULL, \`activo\` tinyint NOT NULL DEFAULT '1', UNIQUE INDEX \`IDX_5147a1f9834ea887b6ad079f5b\` (\`codigo\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`tipos_material\` (\`id\` int NOT NULL AUTO_INCREMENT, \`nombre\` varchar(100) NOT NULL, \`codigo\` varchar(50) NOT NULL, \`activo\` tinyint NOT NULL DEFAULT '1', UNIQUE INDEX \`IDX_9d5b5f0539bf38ef94057247d9\` (\`codigo\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`materiales_capacitacion\` (\`id\` int NOT NULL AUTO_INCREMENT, \`nombre\` varchar(200) NOT NULL, \`url\` varchar(1000) NOT NULL, \`descripcion\` text NULL, \`orden\` int NOT NULL DEFAULT '0', \`activo\` tinyint NOT NULL DEFAULT '1', \`fecha_creacion\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`capacitacion_id\` int NULL, \`tipo_material_id\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`tipos_pregunta\` (\`id\` int NOT NULL AUTO_INCREMENT, \`nombre\` varchar(100) NOT NULL, \`codigo\` varchar(50) NOT NULL, \`permite_multiple_respuesta\` tinyint NOT NULL DEFAULT '0', \`requiere_texto_libre\` tinyint NOT NULL DEFAULT '0', \`activo\` tinyint NOT NULL DEFAULT '1', UNIQUE INDEX \`IDX_d5c17199022eb4a2def526b504\` (\`codigo\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`respuestas_multiples\` (\`id\` int NOT NULL AUTO_INCREMENT, \`respuesta_estudiante_id\` int NULL, \`opcion_respuesta_id\` int NULL, UNIQUE INDEX \`IDX_ec1f5a65dbec68dca47316fe9c\` (\`respuesta_estudiante_id\`, \`opcion_respuesta_id\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`respuestas_estudiante\` (\`id\` int NOT NULL AUTO_INCREMENT, \`texto_respuesta\` text NULL, \`puntaje_obtenido\` decimal(10,2) NOT NULL DEFAULT '0.00', \`fecha_respuesta\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`intento_evaluacion_id\` int NULL, \`pregunta_id\` int NULL, \`opcion_respuesta_id\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`opciones_respuesta\` (\`id\` int NOT NULL AUTO_INCREMENT, \`texto\` varchar(1000) NOT NULL, \`es_correcta\` tinyint NOT NULL DEFAULT '0', \`puntaje_parcial\` decimal(10,2) NOT NULL DEFAULT '0.00', \`orden\` int NOT NULL DEFAULT '0', \`pregunta_id\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`preguntas\` (\`id\` int NOT NULL AUTO_INCREMENT, \`enunciado\` text NOT NULL, \`puntaje\` decimal(10,2) NOT NULL DEFAULT '1.00', \`orden\` int NOT NULL DEFAULT '0', \`requerida\` tinyint NOT NULL DEFAULT '1', \`activo\` tinyint NOT NULL DEFAULT '1', \`evaluacion_id\` int NULL, \`tipo_pregunta_id\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`evaluaciones\` (\`id\` int NOT NULL AUTO_INCREMENT, \`titulo\` varchar(300) NOT NULL, \`descripcion\` text NULL, \`tiempo_limite_minutos\` int NULL, \`intentos_permitidos\` int NOT NULL DEFAULT '1', \`mostrar_resultados\` tinyint NOT NULL DEFAULT '1', \`mostrar_respuestas_correctas\` tinyint NOT NULL DEFAULT '0', \`puntaje_total\` decimal(10,2) NOT NULL DEFAULT '100.00', \`minimo_aprobacion\` decimal(5,2) NOT NULL DEFAULT '70.00', \`orden\` int NOT NULL DEFAULT '0', \`activo\` tinyint NOT NULL DEFAULT '1', \`fecha_creacion\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`capacitacion_id\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`intentos_evaluacion\` (\`id\` int NOT NULL AUTO_INCREMENT, \`numero_intento\` int NOT NULL DEFAULT '1', \`fecha_inicio\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`fecha_finalizacion\` datetime NULL, \`puntaje_obtenido\` decimal(10,2) NOT NULL DEFAULT '0.00', \`puntaje_total\` decimal(10,2) NULL, \`porcentaje\` decimal(5,2) NULL, \`aprobado\` tinyint NULL, \`tiempo_utilizado_minutos\` int NULL, \`estado\` enum ('en_progreso', 'completado', 'abandonado') NOT NULL DEFAULT 'en_progreso', \`evaluacion_id\` int NULL, \`inscripcion_id\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`certificados\` (\`id\` int NOT NULL AUTO_INCREMENT, \`numero_certificado\` varchar(100) NOT NULL, \`fecha_emision\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`fecha_vencimiento\` date NULL, \`url_certificado\` varchar(500) NULL, \`hash_verificacion\` varchar(255) NULL, \`activo\` tinyint NOT NULL DEFAULT '1', \`inscripcion_id\` int NULL, INDEX \`IDX_fb95584eb32fd0fb62e1a80d3b\` (\`hash_verificacion\`), UNIQUE INDEX \`IDX_d7de3909e37252dab1303e34cc\` (\`numero_certificado\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`reseñas\` (\`id\` int NOT NULL AUTO_INCREMENT, \`calificacion\` tinyint NOT NULL, \`comentario\` text NULL, \`fecha_creacion\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`activo\` tinyint NOT NULL DEFAULT '1', \`inscripcion_id\` int NULL, INDEX \`IDX_199a18faf5d8e27374b22ecf30\` (\`calificacion\`), UNIQUE INDEX \`IDX_f008f77e1855f90056d6d1701e\` (\`inscripcion_id\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`inscripciones\` (\`id\` int NOT NULL AUTO_INCREMENT, \`fecha_inscripcion\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`fecha_inicio\` datetime NULL, \`fecha_finalizacion\` datetime NULL, \`progreso_porcentaje\` decimal(5,2) NOT NULL DEFAULT '0.00', \`estado\` enum ('inscrito', 'en_progreso', 'completado', 'abandonado') NOT NULL DEFAULT 'inscrito', \`calificacion_final\` decimal(5,2) NULL, \`aprobado\` tinyint NULL, \`capacitacion_id\` int NULL, \`estudiante_id\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`progreso_lecciones\` (\`id\` int NOT NULL AUTO_INCREMENT, \`completada\` tinyint NOT NULL DEFAULT '0', \`fecha_inicio\` datetime NULL, \`fecha_completada\` datetime NULL, \`tiempo_dedicado_minutos\` int NOT NULL DEFAULT '0', \`inscripcion_id\` int NULL, \`leccion_id\` int NULL, UNIQUE INDEX \`IDX_0b03b3ea485b88a02f3a4045a6\` (\`inscripcion_id\`, \`leccion_id\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`lecciones\` (\`id\` int NOT NULL AUTO_INCREMENT, \`titulo\` varchar(300) NOT NULL, \`descripcion\` text NULL, \`contenido\` longtext NULL, \`video_url\` varchar(500) NULL, \`duracion_minutos\` int NULL, \`orden\` int NOT NULL DEFAULT '0', \`activo\` tinyint NOT NULL DEFAULT '1', \`seccion_id\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`secciones_capacitacion\` (\`id\` int NOT NULL AUTO_INCREMENT, \`titulo\` varchar(300) NOT NULL, \`descripcion\` text NULL, \`orden\` int NOT NULL DEFAULT '0', \`activo\` tinyint NOT NULL DEFAULT '1', \`capacitacion_id\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`capacitaciones\` (\`id\` int NOT NULL AUTO_INCREMENT, \`titulo\` varchar(500) NOT NULL, \`descripcion\` text NULL, \`area_id\` int NULL, \`publico_objetivo\` varchar(200) NULL, \`fecha_inicio\` date NULL, \`fecha_fin\` date NULL, \`duracion_horas\` decimal(5,2) NULL, \`capacidad_maxima\` int NULL, \`imagen_portada_url\` varchar(500) NULL, \`video_promocional_url\` varchar(500) NULL, \`minimo_aprobacion\` decimal(5,2) NOT NULL DEFAULT '70.00', \`porcentaje_eficacia\` decimal(5,2) NULL, \`estado\` enum ('borrador', 'publicada', 'en_curso', 'finalizada', 'cancelada') NOT NULL DEFAULT 'borrador', \`fecha_creacion\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`fecha_actualizacion\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`usuario_creacion\` varchar(50) NOT NULL, \`usuario_actualizacion\` varchar(50) NULL, \`tipo_capacitacion_id\` int NULL, \`modalidad_id\` int NULL, \`instructor_id\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`roles\` (\`id\` int NOT NULL AUTO_INCREMENT, \`nombre\` varchar(50) NOT NULL, \`codigo\` varchar(50) NOT NULL, \`descripcion\` text NULL, \`activo\` tinyint NOT NULL DEFAULT '1', \`fecha_creacion\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), INDEX \`IDX_a5be7aa67e759e347b1c6464e1\` (\`nombre\`), INDEX \`IDX_5def9cb8b6a53b45e58ab82e37\` (\`codigo\`), UNIQUE INDEX \`IDX_a5be7aa67e759e347b1c6464e1\` (\`nombre\`), UNIQUE INDEX \`IDX_5def9cb8b6a53b45e58ab82e37\` (\`codigo\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX \`IDX_0b03b3ea485b88a02f3a4045a6\` ON \`progreso_lecciones\``);
        await queryRunner.query(`DROP TABLE \`progreso_lecciones\``);
        await queryRunner.query(`DROP TABLE \`inscripciones\``);
        await queryRunner.query(`DROP INDEX \`IDX_f008f77e1855f90056d6d1701e\` ON \`reseñas\``);
        await queryRunner.query(`DROP INDEX \`IDX_199a18faf5d8e27374b22ecf30\` ON \`reseñas\``);
        await queryRunner.query(`DROP TABLE \`reseñas\``);
        await queryRunner.query(`DROP INDEX \`IDX_d7de3909e37252dab1303e34cc\` ON \`certificados\``);
        await queryRunner.query(`DROP INDEX \`IDX_fb95584eb32fd0fb62e1a80d3b\` ON \`certificados\``);
        ...
        await queryRunner.query(`DROP INDEX \`IDX_ec1f5a65dbec68dca47316fe9c\` ON \`respuestas_multiples\``);
        await queryRunner.query(`DROP TABLE \`respuestas_multiples\``);
        await queryRunner.query(`DROP INDEX \`IDX_d5c17199022eb4a2def526b504\` ON \`tipos_pregunta\``);
        await queryRunner.query(`DROP TABLE \`tipos_pregunta\``);
        await queryRunner.query(`DROP TABLE \`materiales_capacitacion\``);
        await queryRunner.query(`DROP INDEX \`IDX_9d5b5f0539bf38ef94057247d9\` ON \`tipos_material\``);
        await queryRunner.query(`DROP TABLE \`tipos_material\``);
        await queryRunner.query(`DROP INDEX \`IDX_5147a1f9834ea887b6ad079f5b\` ON \`modalidades_capacitacion\``);
        await queryRunner.query(`DROP TABLE \`modalidades_capacitacion\``);
        await queryRunner.query(`DROP INDEX \`IDX_14199ab69b3551092772c55223\` ON \`tipos_capacitacion\``);
        await queryRunner.query(`DROP TABLE \`tipos_capacitacion\``);
        await queryRunner.query(`DROP INDEX \`REL_37d658e0238dd3373fa1c35dbf\` ON \`instructores\``);
        await queryRunner.query(`DROP TABLE \`instructores\``);
        await queryRunner.query(`DROP INDEX \`REL_81923965e846ea6bc6b1ae7a42\` ON \`alumnos\``);
        await queryRunner.query(`DROP INDEX \`IDX_1c4bf20b7f94e724088a4c9867\` ON \`alumnos\``);
        await queryRunner.query(`DROP INDEX \`IDX_1c4bf20b7f94e724088a4c9867\` ON \`alumnos\``);
