...
export class InitialSchema1766011237783 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`resenas\` ADD CONSTRAINT \`FK_c73e35a20d7d4ffd36b0ad6ca14\` FOREIGN KEY (\`inscripcion_id\`) REFERENCES \`inscripciones\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`resenas\` DROP FOREIGN KEY \`FK_c73e35a20d7d4ffd36b0ad6ca14\``);
        ...
        await queryRunner.query(`DROP INDEX \`IDX_c73e35a20d7d4ffd36b0ad6ca1\` ON \`resenas\``);
        await queryRunner.query(`DROP INDEX \`IDX_629ef95a8ee77cdf8530145676\` ON \`resenas\``);
