...
import { UpdateInstructorDto } from '@/application/catalogos/dto/update-instructor.dto';
...
export class InstructoresCatalogosController {
  ...
  @ApiResponse({
    status: 200,
    description: 'Lista de instructores con persona',
  })
  findAll() {
  ...
  @Patch(':id')
  @Roles('ADMIN')
  @ApiOperation({ summary: 'Actualizar datos del instructor' })
  @ApiResponse({ status: 200, description: 'Instructor actualizado' })
  @ApiResponse({ status: 404, description: 'No encontrado' })
  update(
